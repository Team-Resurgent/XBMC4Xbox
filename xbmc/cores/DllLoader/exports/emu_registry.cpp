...
static char* localregpathname = "ROOT:\\system\\players\\mplayer\\codecs\\registry.dat";
...
static void init_registry(void)
{
  ...
  load_registry_xml("ROOT:\\system\\registry.xml");
  load_registry_xml("USER:\\registry.xml");
}
