...
void URIUtils::Split(const CStdString& strFileNameAndPath, CStdString& strPath, CStdString& strFileName)
{
...
{
  if (IsTuxBox(strFile) || IsVTP(strFile) || IsHDHomeRun(strFile) || IsHTSP(strFile) || IsSlingbox(strFile))
    return true;
